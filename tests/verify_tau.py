...
def test_tau_calculation():
    ...
    sim0 = AthermalSimulation(nx, ny, nz, M=2, gamma0=0.1, E_field=E, nu_field=nu, temperature=0.0)
    ...
    sim300 = AthermalSimulation(nx, ny, nz, M=2, gamma0=0.1, E_field=E, nu_field=nu, temperature=T, q_act_temp=q, nu0=nu0)
